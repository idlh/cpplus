...
public class ProcedimientosI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Tablaimagenologia.setComponentPopupMenu(jPopupMenu1);
    ...
    private void TablaimagenologiaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaimagenologiaMouseEntered
        ...
        Tablaimagenologia.setToolTipText((String) Tablaimagenologia.getValueAt(rowindex, 2));
    ...
    private void JustificacionesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JustificacionesMouseReleased
        ...
        procedi.jLabel2.setText("<html>\n"
                + "<div style=\"width:380;\">" + String.valueOf(Tablaimagenologia.getValueAt(Tablaimagenologia.getSelectedRow(), 2)) + "\n"
                + "</div>\n"
                + "\n"
                + "</html>");
    ...
    private void tabla() {
        try {
            ...
            if (b != 0) {
                ...
                tab.cargartabla(modelo, idhc, "15");
    ...
    public void actproceimage(String idhc) {
            ...
            if (est.toString().equals("3")) {
                for (int i = 0; i < modelo.getRowCount(); i++) {
                    if (modelo.getValueAt(i, 4).equals("0")) {
                        act.actprocedimiento(idhc, modelo.getValueAt(Tablaimagenologia.getSelectedRow(), 0).toString(), "0");
                    }
                }
            } else {
