...
public class Jovensano extends javax.swing.JPanel {
    ...
    public Jovensano(EntityManagerFactory factory, PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setBounds(354, 25, 190, 13);
    ...
    private void jLabel2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseReleased
        ...
        motivoc.jLabel3.setText("Detección Temprana De Las Alteraciones Del Desarrollo Del Joven");
    ...
    private void save(Integer usuario) {
        if (Estadofinal.equals("1")) {
            ...
            if (b == 0) {
                ...
                sav.newjoven(idhc, pypAdmAsistCon.getIdControlPro().getIdProfesional().getId().toString(), fc);
                Object h[][] = Funciones.RetornarDatos(act.cargardatoshc(idhc));
...
//                }
            ...
            if (pypAdmAsistCon.getEstado().toString().equals("1") || pypAdmAsistCon.getEstado().toString().equals("4")) {
    ...
    private void finalizar(Integer usuario) {
        if (Estadofinal.equals("1")) {
            Object a[][] = Funciones.RetornarDatos(sav.contarhc(pypAdmAsistCon.getId().toString()));
            int b = Integer.parseInt(a[0][0].toString());
            if (b == 0) {
