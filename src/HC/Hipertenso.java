...
public class Hipertenso extends javax.swing.JPanel {
    ...
    public Hipertenso(EntityManagerFactory factory, PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void save() {
        if (Estadofinal.equals("1")) {
            ...
            if (b == 0) {
                ...
                sav.newhta(idhc, pypAdmAsistCon.getIdControlPro().getIdProfesional().getId().toString(), fc);
                if (pypAdmAsistCon.getPrimeraVez().toString().equals("0")) {
                    Object data[][] = Funciones.RetornarDatos(sav.selectidhta(idhc));
                    sav.newhtacontrol(data[0][0].toString(), pypAdmAsistCon.getIdControlPro().getIdProfesional().getId().toString(), fc);
                }
                Object h[][] = Funciones.RetornarDatos(act.cargardatoshc(idhc));
                if (h[0][23].toString().equals("0")) {
