...
public class ProcedimientosL extends javax.swing.JPanel {
    ...
    public ProcedimientosL(PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Tablalaboratorio.setComponentPopupMenu(jPopupMenu1);
    ...
    private void jButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseReleased
        if (Tablalaboratorio.getSelectedRow() > -1) {
            if (Tablalaboratorio.getValueAt(Tablalaboratorio.getSelectedRow(), 4).toString().equals("0")) {
                Tablalaboratorio.setValueAt("2", Tablalaboratorio.getSelectedRow(), 4);
                icon = new javax.swing.ImageIcon(getClass().getResource("/Recursos/bullet_green.png"));
                modelo.setValueAt(fila[0] = new JLabel(icon), Tablalaboratorio.getSelectedRow(), 5);
            } else {
                pasarprocedimientos();
            }
        } else {
    ...
    private void TablalaboratorioMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablalaboratorioMouseEntered
        rowindex = Tablalaboratorio.rowAtPoint(evt.getPoint());
        Tablalaboratorio.setToolTipText((String) Tablalaboratorio.getValueAt(rowindex, 2));
    ...
    private void JustificacionesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JustificacionesMouseReleased
        ...
        procedi.jLabel2.setText("<html>\n"
                + "<div style=\"width:380;\">" + String.valueOf(Tablalaboratorio.getValueAt(Tablalaboratorio.getSelectedRow(), 2)) + "\n"
                + "</div>\n"
                + "\n"
                + "</html>");
        procedi.jTextArea1.setText(modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 6).toString());
        if (modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 8).toString().equals("1")) {
        ...
        procedi.jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                modelo.setValueAt(procedi.jTextArea1.getText().toUpperCase(), Tablalaboratorio.getSelectedRow(), 6);
                modelo.setValueAt(examen, Tablalaboratorio.getSelectedRow(), 8);
                icon = new javax.swing.ImageIcon(getClass().getResource("/Recursos/bullet_blue.png"));
                modelo.setValueAt(fila[0] = new JLabel(icon), Tablalaboratorio.getSelectedRow(), 5);
                Tablalaboratorio.setDefaultRenderer(Object.class, new IconCellRendererlabel());
                procedi.dispose();
            }
        });
    ...
    private void tabla() {
        try {
            ...
            Funciones_AD.setOcultarColumnas(Tablalaboratorio, new int[]{0, 3, 4});
            Funciones_AD.setSizeColumnas(Tablalaboratorio, new int[]{1, 2, 5}, new int[]{45, 295, 16});
            ...
            if (b != 0) {
                ...
                tab.cargartabla(modelo, idhc, "17");
            ...
            JOptionPane.showMessageDialog(null, "error: " + e.getMessage().toString(), ProcedimientosL.class.getName(), JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    public void quitarrgistro() {
        if (modelo.getRowCount() > 0 && Tablalaboratorio.getSelectedRow() > -1) {
            if (modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 4).equals("2")) {
                modelo.setValueAt("0", Tablalaboratorio.getSelectedRow(), 4);
                if (modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 4).equals("0")) {
                ...
                if (modelo.getRowCount() > 0 && Tablalaboratorio.getSelectedRow() > -1) {
                    if (modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 4).equals("1")) {
    ...
    public void actprocelab(String idhc) {
            ...
            if (est.toString().equals("3")) {
                for (int i = 0; i < modelo.getRowCount(); i++) {
                    if (modelo.getValueAt(i, 4).equals("0")) {
                        act.actprocedimiento(idhc, modelo.getValueAt(Tablalaboratorio.getSelectedRow(), 0).toString(), "0");
                    }
                }
            } else {
