...
public class ProcedimientosO extends javax.swing.JPanel {
    ...
    public ProcedimientosO(PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Trablaotrosprocedimientos.setComponentPopupMenu(jPopupMenu1);
    ...
    private void jButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseReleased
        if (Trablaotrosprocedimientos.getSelectedRow() > -1) {
            if (Trablaotrosprocedimientos.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 4).toString().equals("0")) {
                Trablaotrosprocedimientos.setValueAt("2", Trablaotrosprocedimientos.getSelectedRow(), 4);
                icon = new javax.swing.ImageIcon(getClass().getResource("/Recursos/bullet_green.png"));
                modelo.setValueAt(fila[0] = new JLabel(icon), Trablaotrosprocedimientos.getSelectedRow(), 5);
            } else {
                pasarprocedimientos();
            }
        } else {
    ...
    private void JustificacionesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JustificacionesMouseReleased
        ...
        procedi.jLabel2.setText("<html>\n"
                + "<div style=\"width:380;\">" + String.valueOf(Trablaotrosprocedimientos.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 2)) + "\n"
                + "</div>\n"
                + "\n"
                + "</html>");
        procedi.jTextArea1.setText(modelo.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 6).toString());
        if (modelo.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 8).toString().equals("1")) {
        ...
        procedi.jButton1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                modelo.setValueAt(procedi.jTextArea1.getText().toUpperCase(), Trablaotrosprocedimientos.getSelectedRow(), 6);
                modelo.setValueAt(examen, Trablaotrosprocedimientos.getSelectedRow(), 8);
    ...
    private void tabla() {
        try {
            ...
            Funciones_AD.setOcultarColumnas(Trablaotrosprocedimientos, new int[]{0, 3, 4});
            Funciones_AD.setSizeColumnas(Trablaotrosprocedimientos, new int[]{1, 2, 5}, new int[]{45, 295, 16});
    ...
    public void quitarrgistro() {
        if (modelo.getRowCount() > 0 && Trablaotrosprocedimientos.getSelectedRow() > -1) {
            if (modelo.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 4).equals("2")) {
                modelo.setValueAt("0", Trablaotrosprocedimientos.getSelectedRow(), 4);
                if (modelo.getValueAt(Trablaotrosprocedimientos.getSelectedRow(), 4).equals("0")) {
