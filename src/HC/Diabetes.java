...
public class Diabetes extends javax.swing.JPanel {
    ...
    public Diabetes(EntityManagerFactory factory, PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void save() {
        if (Estadofinal.equals("1")) {
            ...
            if (b == 0) {
                ...
                sav.newdm(idhc, pypAdmAsistCon.getIdControlPro().getIdProfesional().getId().toString(), fc);
                Object h[][] = Funciones.RetornarDatos(act.cargardatoshc(idhc));
                if (h[0][23].toString().equals("0")) {
