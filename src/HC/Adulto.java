...
public class Adulto extends javax.swing.JPanel {
    ...
    public Adulto(EntityManagerFactory factory, PypAdmAsistCon pypAdmAsistCon, Integer usuario) {
        initComponents();
    ...
    private void save() {
        if (Estadofinal.equals("1")) {
            ...
            if (b == 0) {
                ...
                sav.newadulto(idhc, pypAdmAsistCon.getIdControlPro().getIdProfesional().getId().toString(), fc);
