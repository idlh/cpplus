...
public class visual extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Valoracion de la Agudeza Visual", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel2.setText("Medición normal");

        jLabel4.setText("Ojo derecho:");

        jLabel5.setText("Ojo izquierdo:");
        ...
        jLabel7.setText("Ojo derecho:");

        jLabel8.setText("Ojo izquierdo:");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        jLabel9.setText("Medición con anteojos");

        jLabel10.setText("Ambos:");
        ...
        jLabel12.setText("Pies");

        jLabel13.setText("Pies");

        jLabel14.setText("Pies");

        jLabel15.setText("Pies");

        jLabel16.setText("Pies");
    ...
    public void cargarvisual() {
        ...
        jTextField4.setText(h[0][5].toString());
        jTextField5.setText(h[0][6].toString());
        jTextField6.setText(h[0][7].toString());
        jTextArea1.setText(h[0][8].toString());
    }
