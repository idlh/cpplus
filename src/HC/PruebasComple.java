...
public class PruebasComple extends javax.swing.JPanel {
    ...
    public PypAdmAsistCon pypAdmAsistCon;
    ...
    private String ReturnPathdiagHelpSaveFile(String tipo) {
        ...
        ahoraCal.setTime(pypAdmAsistCon.getFecha());
        String year = String.valueOf(ahoraCal.get(Calendar.YEAR));
        String month = String.valueOf(ahoraCal.get(Calendar.MONTH));
        return pypAdmAsistCon.getIdAgend().getIdPaciente().getNumDoc() + s + year + s + month + s + pypAdmAsistCon.getId() + s + tipo;
    }
    private void jButton1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseReleased
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            seleccion = (String) JOptionPane.showInputDialog(this, "Tipo de Archivo Adjunto", "Mensaje",
